...
{
    x += Util::GenerateRandom(0, 1);
    y += Util::GenerateRandom(0, 1);
//    rand() function isnt good
    if (x >= LIMX - 5) x = Util::GenerateRandom(0, LIMX);
    if (y >= LIMX - 5) y = Util::GenerateRandom(0, LIMX);
